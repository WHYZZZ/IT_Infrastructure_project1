...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-third">
    ...
    <?php 
          if(isset($_SESSION['id']))
            ...
            <?php   echo "<img src='{$userData['image_dir']}' width='100%' height='auto' vertical-align='middle'>";  ?>
  ...
  <!-- End Left Column -->
    ...
    <div class="w3-container w3-card w3-white w3-margin-bottom">
      ...
      <div class="w3-container w3-card w3-white">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Admin Privileges</h2>
        <div class="w3-container">
          <a href="add_user.php"><h4 class="w3-opacity"><b>Add Employee</b></h4></a>
          <hr>
        </div>

        <div class="w3-container">
          <a href="delete_user.php"><h4 class="w3-opacity"><b>Delete Employee</b></h4></a>
          <hr>
        </div>

        <div class="w3-container">
          <a href="violations.php"><h4 class="w3-opacity"><b>Add Violations</b></h4></a>
        </div>
      </div>
