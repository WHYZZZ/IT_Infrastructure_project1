...
<div class="row">
  <div class="column">
    <div class="card">
      <a href="vacancies.php"><h3>HR assistant</h3></a>
    </div>
  </div>

  <div class="column">
    <div class="card">
      <a href="vacancies.php"><h3>Junior recruiters</h3></a>
    </div>
  </div>
  
  <div class="column">
    <div class="card">
      <a href="vacancies.php"><h3>Benefits clerk</h3></a>
    </div>
  </div>
  
  <div class="column">
    <div class="card">
      <A href="vacancies.php"><h3>HR manager</h3></a>
    </div>
  </div>
...
<div class="row-2">
  <div class="column">
    <div class="card">
     <a href="vacancies.php"> <h3>HR generalist</h3></a>
    </div>
  </div>
  
  <div class="column">
    <div class="card">
      <a href="vacancies.php"> <h3>Senior HR specialist</h3></a>
    </div>
  </div>
  
    <div class="column">
    <div class="card">
      <a href="vacancies.php"> <h3>Senior HR manager</h3></a>
    </div>
  </div>
  
  <div class="column">
    <div class="card">
     <a href="vacancies.php">  <h3>Junior manager</h3></a>
    </div>
  </div>
